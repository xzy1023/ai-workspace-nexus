...
# C# & .NET Engineering Guidelines

## When to use this skill
Use this skill when:
- Working on C# or .NET projects (files ending in `.cs`, `.csproj`, or `.sln`).
- Implementing C# logic, services, database contexts, or test projects.

## How to use it
Adhere to the following C# coding guidelines, resource management patterns, and testing standards:
